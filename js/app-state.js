...
const ShapeGimbalInput = document.getElementById("ShapeGimbalInput");
const ShapeGimbalRollInput = document.getElementById("ShapeGimbalRollInput");
const ShapeOverlapSection = document.getElementById("ShapeOverlapSection");
const ShapeOverlapToggle = document.getElementById("ShapeOverlapToggle");
const ShapeOverlapInput = document.getElementById("ShapeOverlapInput");
const ShapePhotoIntervalInput = document.getElementById("ShapePhotoIntervalInput");
const ShapePhotoSpeedInput = document.getElementById("ShapePhotoSpeedInput");
