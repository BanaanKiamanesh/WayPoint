...
const LineOffsetInput = document.getElementById("LineOffsetInput");
const AlignToLineBtn = document.getElementById("AlignToLineBtn");
const AlignToPoiBtn = document.getElementById("AlignToPoiBtn");
